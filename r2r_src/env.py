                ...
                if args.ADAPT:
                    if "/" in split:
                        try:
                            ...
                            new_item['img_sub_prompt'] = item['positive_trajectory'][str(new_item['instr_id'])]
                            new_item['txt_sub_prompt'] = item['positive_obj_index'][str(new_item['instr_id'])]
                            new_item['prompt_num'] = item['positive_trajectory_length'][
                                str(new_item['instr_id'])]
                        ...
                        for j, instr in enumerate(item['instructions']):
                            try:
                                ...
                                new_item['img_sub_prompt'] = item['positive_trajectory'][new_item['instr_id']]
                                new_item['txt_sub_prompt'] = item['positive_obj_index'][
                                    str(new_item['instr_id'])]
                                new_item['prompt_num'] = item['positive_trajectory_length'][
                                    new_item['instr_id']]
                                if new_item['instr_encoding'] is not None:  # Filter the wrong data
        ...
        for i, (feature, state) in enumerate(self.env.getStates()):
            ...
            if args.ADAPT:
                obs.append({
                    ...
                    'img_sub_prompt': item['img_sub_prompt'],
                    'txt_sub_prompt': item['txt_sub_prompt'],
