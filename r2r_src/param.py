...
class Param:
    def __init__(self):
        ...
        # ADAPT
        self.parser.add_argument("--ADAPT", action='store_const', default=False, const=True, help='use ADAPT model')
        self.parser.add_argument("--AlignLossWeight", dest='align_loss_weight',  default=0.01, type=float, help="modality alignment loss weight")
        self.parser.add_argument("--ConsistencyLossWeight", dest='consistency_loss_weight',  default=0.0001, type=float, help="sequential consistency loss weight")
        self.parser.add_argument('--prompt_set_size', type=int, default=60, help="prompt set size")
        self.parser.add_argument("--temperature", default=0.5, type=float, help="hyperparameter for contrastive loss")
        self.parser.add_argument("--finetune", action='store_const', default=False, const=True, help='if in finetune stage')
