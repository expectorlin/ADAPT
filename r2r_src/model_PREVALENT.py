...
class VLNBERT(nn.Module):
    ...
    def forward(self, mode, sentence, token_type_ids=None,
                ...
                position_ids=None, action_feats=None, pano_feats=None, cand_feats=None, prompt_mask_set=None,
        ...
        if mode == 'language':
            ...
            if txt_sub_prompt_set is not None and img_sub_prompt_set is not None:
                h_t, logit, attended_language, attended_visual, attended_txt_prompt, attended_img_prompt, txt_prompt, img_prompt = self.vln_bert(
                    mode,
                    state_feats,
            ...
            if txt_sub_prompt_set is not None and img_sub_prompt_set is not None:
                return state_proj, logit, attended_language, attended_visual, attended_txt_prompt, attended_img_prompt, txt_prompt, img_prompt
            else:
